"""Parity test: synthetic CVs with known skills must rank for their skills."""
...
from cvengine.synthetic import build_cv_text, generate_profiles, profile_metadata
...
def test_parity_known_skills_rank_on_top(chroma_repo):
    ...
    hit_count = 0
    for profile in profiles:
        primary = profile.primary_skills[0]
