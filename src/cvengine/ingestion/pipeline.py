...
class IngestionPipeline:
    ...
    def ingest_structured(
        ...
        """Ingest already-structured sections (e.g. generated by an LLM).

        The section texts are concatenated to form the resource body; each
        section keeps its keywords.

        :param sectioning: a SectioningOutput with sections and keywords
